...
CIMGUI_API ImGuiIO*         ImGuiGetIOImGuiContextPtr(ImGuiContext* ctx);
CIMGUI_API ImGuiPlatformIO* ImGuiGetPlatformIOImGuiContextPtr(ImGuiContext* ctx);
CIMGUI_API ImGuiWindow*     ImGuiGetCurrentWindowRead(void);
CIMGUI_API ImGuiWindow*     ImGuiGetCurrentWindow(void);
CIMGUI_API ImGuiWindow*     ImGuiFindWindowByID(ImGuiID id);
CIMGUI_API ImGuiWindow*     ImGuiFindWindowByName(const char* name);
CIMGUI_API void             ImGuiUpdateWindowParentAndRootLinks(ImGuiWindow* window, ImGuiWindowFlags flags, ImGuiWindow* parent_window);
CIMGUI_API void             ImGuiUpdateWindowSkipRefresh(ImGuiWindow* window);
CIMGUI_API ImVec2           ImGuiCalcWindowNextAutoFitSize(ImGuiWindow* window);
CIMGUI_API bool             ImGuiIsWindowChildOf(ImGuiWindow* window, ImGuiWindow* potential_parent, bool popup_hierarchy);
CIMGUI_API bool             ImGuiIsWindowInBeginStack(ImGuiWindow* window);
CIMGUI_API bool             ImGuiIsWindowWithinBeginStackOf(ImGuiWindow* window, ImGuiWindow* potential_parent);
CIMGUI_API bool             ImGuiIsWindowAbove(ImGuiWindow* potential_above, ImGuiWindow* potential_below);
CIMGUI_API bool             ImGuiIsWindowNavFocusable(ImGuiWindow* window);
CIMGUI_API void             ImGuiSetWindowPosImGuiWindowPtr(ImGuiWindow* window, ImVec2 pos, ImGuiCond cond /* = 0 */);
CIMGUI_API void             ImGuiSetWindowSizeImGuiWindowPtr(ImGuiWindow* window, ImVec2 size, ImGuiCond cond /* = 0 */);
CIMGUI_API void             ImGuiSetWindowCollapsedImGuiWindowPtr(ImGuiWindow* window, bool collapsed, ImGuiCond cond /* = 0 */);
CIMGUI_API void             ImGuiSetWindowHitTestHole(ImGuiWindow* window, ImVec2 pos, ImVec2 size);
CIMGUI_API void             ImGuiSetWindowHiddenAndSkipItemsForCurrentFrame(ImGuiWindow* window);
CIMGUI_API void             ImGuiSetWindowParentWindowForFocusRoute(ImGuiWindow* window, ImGuiWindow* parent_window);
CIMGUI_API ImRect           ImGuiWindowRectAbsToRel(ImGuiWindow* window, ImRect r);
CIMGUI_API ImRect           ImGuiWindowRectRelToAbs(ImGuiWindow* window, ImRect r);
CIMGUI_API ImVec2           ImGuiWindowPosAbsToRel(ImGuiWindow* window, ImVec2 p);
CIMGUI_API ImVec2           ImGuiWindowPosRelToAbs(ImGuiWindow* window, ImVec2 p);

// Windows: Display Order and Focus Order
CIMGUI_API void         ImGuiFocusWindow(ImGuiWindow* window, ImGuiFocusRequestFlags flags /* = 0 */);
CIMGUI_API void         ImGuiFocusTopMostWindowUnderOne(ImGuiWindow* under_this_window, ImGuiWindow* ignore_window, ImGuiViewport* filter_viewport, ImGuiFocusRequestFlags flags);
CIMGUI_API void         ImGuiBringWindowToFocusFront(ImGuiWindow* window);
CIMGUI_API void         ImGuiBringWindowToDisplayFront(ImGuiWindow* window);
CIMGUI_API void         ImGuiBringWindowToDisplayBack(ImGuiWindow* window);
CIMGUI_API void         ImGuiBringWindowToDisplayBehind(ImGuiWindow* window, ImGuiWindow* above_window);
CIMGUI_API int          ImGuiFindWindowDisplayIndex(ImGuiWindow* window);
CIMGUI_API ImGuiWindow* ImGuiFindBottomMostVisibleWindowWithinBeginStack(ImGuiWindow* window);

// Windows: Idle, Refresh Policies [EXPERIMENTAL]
CIMGUI_API void ImGuiSetNextWindowRefreshPolicy(ImGuiWindowRefreshFlags flags);

// Fonts, drawing
CIMGUI_API void        ImGuiRegisterUserTexture(ImTextureData* tex);                          // Register external texture. EXPERIMENTAL: DO NOT USE YET.
CIMGUI_API void        ImGuiUnregisterUserTexture(ImTextureData* tex);
CIMGUI_API void        ImGuiRegisterFontAtlas(ImFontAtlas* atlas);
CIMGUI_API void        ImGuiUnregisterFontAtlas(ImFontAtlas* atlas);
CIMGUI_API void        ImGuiSetCurrentFont(ImFont* font, float font_size_before_scaling, float font_size_after_scaling);
CIMGUI_API void        ImGuiUpdateCurrentFontSize(float restore_font_size_after_scaling);
CIMGUI_API void        ImGuiSetFontRasterizerDensity(float rasterizer_density);
CIMGUI_API float       ImGuiGetFontRasterizerDensity(void);
CIMGUI_API float       ImGuiGetRoundedFontSize(float size);
CIMGUI_API ImFont*     ImGuiGetDefaultFont(void);
CIMGUI_API void        ImGuiPushPasswordFont(void);
CIMGUI_API void        ImGuiPopPasswordFont(void);
CIMGUI_API ImDrawList* ImGuiGetForegroundDrawListImGuiWindowPtr(ImGuiWindow* window);         // This seemingly unnecessary wrapper simplifies compatibility between the 'master' and 'docking' branches.
CIMGUI_API ImDrawList* ImGuiGetBackgroundDrawListImGuiViewportPtr(ImGuiViewport* viewport);   // get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear imgui contents.
CIMGUI_API ImDrawList* ImGuiGetForegroundDrawListImGuiViewportPtr(ImGuiViewport* viewport);   // get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents.
CIMGUI_API void        ImGuiAddDrawListToDrawDataEx(ImDrawData* draw_data, ImVector_ImDrawListPtr* out_list, ImDrawList* draw_list);

// Init
CIMGUI_API void ImGuiInitialize(void);
CIMGUI_API void ImGuiShutdown(void);   // Since 1.60 this is a _private_ function. You can call DestroyContext() to destroy the context created by CreateContext().

// NewFrame
CIMGUI_API void ImGuiUpdateInputEvents(bool trickle_fast_inputs);
CIMGUI_API void ImGuiUpdateHoveredWindowAndCaptureFlags(ImVec2 mouse_pos);
CIMGUI_API void ImGuiFindHoveredWindowEx(ImVec2 pos, bool find_first_and_in_any_viewport, ImGuiWindow** out_hovered_window, ImGuiWindow** out_hovered_window_under_moving_window);
CIMGUI_API void ImGuiStartMouseMovingWindow(ImGuiWindow* window);
CIMGUI_API void ImGuiStopMouseMovingWindow(void);
CIMGUI_API void ImGuiUpdateMouseMovingWindowNewFrame(void);
CIMGUI_API void ImGuiUpdateMouseMovingWindowEndFrame(void);

// Generic context hooks
CIMGUI_API ImGuiID ImGuiAddContextHook(ImGuiContext* context, const ImGuiContextHook* hook);
CIMGUI_API void    ImGuiRemoveContextHook(ImGuiContext* context, ImGuiID hook_to_remove);
CIMGUI_API void    ImGuiCallContextHooks(ImGuiContext* context, ImGuiContextHookType type);

// Viewports
CIMGUI_API void ImGuiScaleWindowsInViewport(ImGuiViewportP* viewport, float scale);
CIMGUI_API void ImGuiSetWindowViewport(ImGuiWindow* window, ImGuiViewportP* viewport);

// Settings
CIMGUI_API void                  ImGuiMarkIniSettingsDirty(void);
CIMGUI_API void                  ImGuiMarkIniSettingsDirtyImGuiWindowPtr(ImGuiWindow* window);
CIMGUI_API void                  ImGuiClearIniSettings(void);
CIMGUI_API void                  ImGuiAddSettingsHandler(const ImGuiSettingsHandler* handler);
CIMGUI_API void                  ImGuiRemoveSettingsHandler(const char* type_name);
CIMGUI_API ImGuiSettingsHandler* ImGuiFindSettingsHandler(const char* type_name);

// Settings - Windows
CIMGUI_API ImGuiWindowSettings* ImGuiCreateNewWindowSettings(const char* name);
CIMGUI_API ImGuiWindowSettings* ImGuiFindWindowSettingsByID(ImGuiID id);
CIMGUI_API ImGuiWindowSettings* ImGuiFindWindowSettingsByWindow(ImGuiWindow* window);
CIMGUI_API void                 ImGuiClearWindowSettings(const char* name);

// Localization
CIMGUI_API void        ImGuiLocalizeRegisterEntries(const ImGuiLocEntry* entries, int count);
CIMGUI_API const char* ImGuiLocalizeGetMsg(ImGuiLocKey key);

// Scrolling
CIMGUI_API void ImGuiSetScrollXImGuiWindowPtr(ImGuiWindow* window, float scroll_x);
CIMGUI_API void ImGuiSetScrollYImGuiWindowPtr(ImGuiWindow* window, float scroll_y);
CIMGUI_API void ImGuiSetScrollFromPosXImGuiWindowPtr(ImGuiWindow* window, float local_x, float center_x_ratio);
CIMGUI_API void ImGuiSetScrollFromPosYImGuiWindowPtr(ImGuiWindow* window, float local_y, float center_y_ratio);

// Early work-in-progress API (ScrollToItem() will become public)
CIMGUI_API void   ImGuiScrollToItem(ImGuiScrollFlags flags /* = 0 */);
CIMGUI_API void   ImGuiScrollToRect(ImGuiWindow* window, ImRect rect, ImGuiScrollFlags flags /* = 0 */);
CIMGUI_API ImVec2 ImGuiScrollToRectEx(ImGuiWindow* window, ImRect rect, ImGuiScrollFlags flags /* = 0 */);
//#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API void   ImGuiScrollToBringRectIntoView(ImGuiWindow* window, ImRect rect);
//#endif

// Basic Accessors
CIMGUI_API ImGuiItemStatusFlags ImGuiGetItemStatusFlags(void);
CIMGUI_API ImGuiItemFlags       ImGuiGetItemFlags(void);
CIMGUI_API ImGuiID              ImGuiGetActiveID(void);
CIMGUI_API ImGuiID              ImGuiGetFocusID(void);
CIMGUI_API void                 ImGuiSetActiveID(ImGuiID id, ImGuiWindow* window);
CIMGUI_API void                 ImGuiSetFocusID(ImGuiID id, ImGuiWindow* window);
CIMGUI_API void                 ImGuiClearActiveID(void);
CIMGUI_API ImGuiID              ImGuiGetHoveredID(void);
CIMGUI_API void                 ImGuiSetHoveredID(ImGuiID id);
CIMGUI_API void                 ImGuiKeepAliveID(ImGuiID id);
CIMGUI_API void                 ImGuiMarkItemEdited(ImGuiID id);                                                         // Mark data associated to given item as "edited", used by IsItemDeactivatedAfterEdit() function.
CIMGUI_API void                 ImGuiPushOverrideID(ImGuiID id);                                                         // Push given value as-is at the top of the ID stack (whereas PushID combines old and new hashes)
CIMGUI_API ImGuiID              ImGuiGetIDWithSeedStr(const char* str_id_begin, const char* str_id_end, ImGuiID seed);
CIMGUI_API ImGuiID              ImGuiGetIDWithSeed(int n, ImGuiID seed);

// Basic Helpers for widget code
CIMGUI_API void   ImGuiItemSize(ImVec2 size);                                                                       // Implied text_baseline_y = -1.0f
CIMGUI_API void   ImGuiItemSizeEx(ImVec2 size, float text_baseline_y /* = -1.0f */);
CIMGUI_API void   ImGuiItemSizeImRect(ImRect bb);                                                                   // Implied text_baseline_y = -1.0f
CIMGUI_API void   ImGuiItemSizeImRectEx(ImRect bb, float text_baseline_y /* = -1.0f */);                            // FIXME: This is a misleading API since we expect CursorPos to be bb.Min.
CIMGUI_API bool   ImGuiItemAdd(ImRect bb, ImGuiID id);                                                              // Implied nav_bb = NULL, extra_flags = 0
CIMGUI_API bool   ImGuiItemAddEx(ImRect bb, ImGuiID id, const ImRect* nav_bb /* = NULL */, ImGuiItemFlags extra_flags /* = 0 */);
CIMGUI_API bool   ImGuiItemHoverable(ImRect bb, ImGuiID id, ImGuiItemFlags item_flags);
CIMGUI_API bool   ImGuiIsWindowContentHoverable(ImGuiWindow* window, ImGuiHoveredFlags flags /* = 0 */);
CIMGUI_API bool   ImGuiIsClippedEx(ImRect bb, ImGuiID id);
CIMGUI_API void   ImGuiSetLastItemData(ImGuiID item_id, ImGuiItemFlags item_flags, ImGuiItemStatusFlags status_flags, ImRect item_rect);
CIMGUI_API ImVec2 ImGuiCalcItemSize(ImVec2 size, float default_w, float default_h);
CIMGUI_API float  ImGuiCalcWrapWidthForPos(ImVec2 pos, float wrap_pos_x);
CIMGUI_API void   ImGuiPushMultiItemsWidths(int components, float width_full);
CIMGUI_API void   ImGuiShrinkWidths(ImGuiShrinkWidthItem* items, int count, float width_excess, float width_min);
CIMGUI_API void   ImGuiCalcClipRectVisibleItemsY(ImRect clip_rect, ImVec2 pos, float items_height, int* out_visible_start, int* out_visible_end);

// Parameter stacks (shared)
CIMGUI_API const ImGuiStyleVarInfo* ImGuiGetStyleVarInfo(ImGuiStyleVar idx);
CIMGUI_API void                     ImGuiBeginDisabledOverrideReenable(void);
CIMGUI_API void                     ImGuiEndDisabledOverrideReenable(void);

// Logging/Capture
CIMGUI_API void ImGuiLogBegin(ImGuiLogFlags flags, int auto_open_depth);                                              // -> BeginCapture() when we design v2 api, for now stay under the radar by using the old name.
CIMGUI_API void ImGuiLogToBuffer(void);                                                                               // Implied auto_open_depth = -1
CIMGUI_API void ImGuiLogToBufferEx(int auto_open_depth /* = -1 */);                                                   // Start logging/capturing to internal buffer
CIMGUI_API void ImGuiLogRenderedText(const ImVec2* ref_pos, const char* text);                                        // Implied text_end = NULL
CIMGUI_API void ImGuiLogRenderedTextEx(const ImVec2* ref_pos, const char* text, const char* text_end /* = NULL */);
CIMGUI_API void ImGuiLogSetNextTextDecoration(const char* prefix, const char* suffix);

// Childs
CIMGUI_API bool ImGuiBeginChildEx(const char* name, ImGuiID id, ImVec2 size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags);

// Popups, Modals
CIMGUI_API bool         ImGuiBeginPopupEx(ImGuiID id, ImGuiWindowFlags extra_window_flags);
CIMGUI_API bool         ImGuiBeginPopupMenuEx(ImGuiID id, const char* label, ImGuiWindowFlags extra_window_flags);
CIMGUI_API void         ImGuiOpenPopupEx(ImGuiID id);                                                                    // Implied popup_flags = ImGuiPopupFlags_None
CIMGUI_API void         ImGuiOpenPopupExEx(ImGuiID id, ImGuiPopupFlags popup_flags /* = ImGuiPopupFlags_None */);
CIMGUI_API void         ImGuiClosePopupToLevel(int remaining, bool restore_focus_to_window_under_popup);
CIMGUI_API void         ImGuiClosePopupsOverWindow(ImGuiWindow* ref_window, bool restore_focus_to_window_under_popup);
CIMGUI_API void         ImGuiClosePopupsExceptModals(void);
CIMGUI_API bool         ImGuiIsPopupOpenID(ImGuiID id, ImGuiPopupFlags popup_flags);
CIMGUI_API ImRect       ImGuiGetPopupAllowedExtentRect(ImGuiWindow* window);
CIMGUI_API ImGuiWindow* ImGuiGetTopMostPopupModal(void);
CIMGUI_API ImGuiWindow* ImGuiGetTopMostAndVisiblePopupModal(void);
CIMGUI_API ImGuiWindow* ImGuiFindBlockingModal(ImGuiWindow* window);
CIMGUI_API ImVec2       ImGuiFindBestWindowPosForPopup(ImGuiWindow* window);
CIMGUI_API ImVec2       ImGuiFindBestWindowPosForPopupEx(ImVec2 ref_pos, ImVec2 size, ImGuiDir* last_dir, ImRect r_outer, ImRect r_avoid, ImGuiPopupPositionPolicy policy);

// Tooltips
CIMGUI_API bool ImGuiBeginTooltipEx(ImGuiTooltipFlags tooltip_flags, ImGuiWindowFlags extra_window_flags);
CIMGUI_API bool ImGuiBeginTooltipHidden(void);

// Menus
CIMGUI_API bool ImGuiBeginViewportSideBar(const char* name, ImGuiViewport* viewport, ImGuiDir dir, float size, ImGuiWindowFlags window_flags);
CIMGUI_API bool ImGuiBeginMenuWithIcon(const char* label, const char* icon);                                // Implied enabled = true
CIMGUI_API bool ImGuiBeginMenuWithIconEx(const char* label, const char* icon, bool enabled /* = true */);
CIMGUI_API bool ImGuiMenuItemWithIcon(const char* label, const char* icon);                                 // Implied shortcut = NULL, selected = false, enabled = true
CIMGUI_API bool ImGuiMenuItemWithIconEx(const char* label, const char* icon, const char* shortcut /* = NULL */, bool selected /* = false */, bool enabled /* = true */);

// Combos
CIMGUI_API bool ImGuiBeginComboPopup(ImGuiID popup_id, ImRect bb, ImGuiComboFlags flags);
CIMGUI_API bool ImGuiBeginComboPreview(void);
CIMGUI_API void ImGuiEndComboPreview(void);

// Keyboard/Gamepad Navigation
CIMGUI_API void ImGuiNavInitWindow(ImGuiWindow* window, bool force_reinit);
CIMGUI_API void ImGuiNavInitRequestApplyResult(void);
CIMGUI_API bool ImGuiNavMoveRequestButNoResultYet(void);
CIMGUI_API void ImGuiNavMoveRequestSubmit(ImGuiDir move_dir, ImGuiDir clip_dir, ImGuiNavMoveFlags move_flags, ImGuiScrollFlags scroll_flags);
CIMGUI_API void ImGuiNavMoveRequestForward(ImGuiDir move_dir, ImGuiDir clip_dir, ImGuiNavMoveFlags move_flags, ImGuiScrollFlags scroll_flags);
CIMGUI_API void ImGuiNavMoveRequestResolveWithLastItem(ImGuiNavItemData* result);
CIMGUI_API void ImGuiNavMoveRequestResolveWithPastTreeNode(ImGuiNavItemData* result, const ImGuiTreeNodeStackData* tree_node_data);
CIMGUI_API void ImGuiNavMoveRequestCancel(void);
CIMGUI_API void ImGuiNavMoveRequestApplyResult(void);
CIMGUI_API void ImGuiNavMoveRequestTryWrapping(ImGuiWindow* window, ImGuiNavMoveFlags move_flags);
CIMGUI_API void ImGuiNavHighlightActivated(ImGuiID id);
CIMGUI_API void ImGuiNavClearPreferredPosForAxis(ImGuiAxis axis);
CIMGUI_API void ImGuiSetNavCursorVisibleAfterMove(void);
CIMGUI_API void ImGuiNavUpdateCurrentWindowIsScrollPushableX(void);
CIMGUI_API void ImGuiSetNavWindow(ImGuiWindow* window);
CIMGUI_API void ImGuiSetNavID(ImGuiID id, ImGuiNavLayer nav_layer, ImGuiID focus_scope_id, ImRect rect_rel);
CIMGUI_API void ImGuiSetNavFocusScope(ImGuiID focus_scope_id);

// Focus/Activation
// This should be part of a larger set of API: FocusItem(offset = -1), FocusItemByID(id), ActivateItem(offset = -1), ActivateItemByID(id) etc. which are
// much harder to design and implement than expected. I have a couple of private branches on this matter but it's not simple. For now implementing the easy ones.
CIMGUI_API void ImGuiFocusItem(void);                // Focus last item (no selection/activation).
CIMGUI_API void ImGuiActivateItemByID(ImGuiID id);   // Activate an item by ID (button, checkbox, tree node etc.). Activation is queued and processed on the next frame when the item is encountered again. Was called 'ActivateItem()' before 1.89.7.

// Inputs
// FIXME: Eventually we should aim to move e.g. IsActiveIdUsingKey() into IsKeyXXX functions.
CIMGUI_API bool          ImGuiIsNamedKey(ImGuiKey key);
CIMGUI_API bool          ImGuiIsNamedKeyOrMod(ImGuiKey key);
CIMGUI_API bool          ImGuiIsLegacyKey(ImGuiKey key);
CIMGUI_API bool          ImGuiIsKeyboardKey(ImGuiKey key);
CIMGUI_API bool          ImGuiIsGamepadKey(ImGuiKey key);
CIMGUI_API bool          ImGuiIsMouseKey(ImGuiKey key);
CIMGUI_API bool          ImGuiIsAliasKey(ImGuiKey key);
CIMGUI_API bool          ImGuiIsLRModKey(ImGuiKey key);
CIMGUI_API ImGuiKeyChord ImGuiFixupKeyChord(ImGuiKeyChord key_chord);
CIMGUI_API ImGuiKey      ImGuiConvertSingleModFlagToKey(ImGuiKey key);

CIMGUI_API ImGuiKeyData* ImGuiGetKeyDataImGuiContextPtr(ImGuiContext* ctx, ImGuiKey key);
CIMGUI_API ImGuiKeyData* ImGuiGetKeyData(ImGuiKey key);
CIMGUI_API const char*   ImGuiGetKeyChordName(ImGuiKeyChord key_chord);
CIMGUI_API ImGuiKey      ImGuiMouseButtonToKey(ImGuiMouseButton button);
CIMGUI_API bool          ImGuiIsMouseDragPastThreshold(ImGuiMouseButton button);                                              // Implied lock_threshold = -1.0f
CIMGUI_API bool          ImGuiIsMouseDragPastThresholdEx(ImGuiMouseButton button, float lock_threshold /* = -1.0f */);
CIMGUI_API ImVec2        ImGuiGetKeyMagnitude2d(ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down);
CIMGUI_API float         ImGuiGetNavTweakPressedAmount(ImGuiAxis axis);
CIMGUI_API int           ImGuiCalcTypematicRepeatAmount(float t0, float t1, float repeat_delay, float repeat_rate);
CIMGUI_API void          ImGuiGetTypematicRepeatRate(ImGuiInputFlags flags, float* repeat_delay, float* repeat_rate);
CIMGUI_API void          ImGuiTeleportMousePos(ImVec2 pos);
CIMGUI_API void          ImGuiSetActiveIdUsingAllKeyboardKeys(void);
CIMGUI_API bool          ImGuiIsActiveIdUsingNavDir(ImGuiDir dir);
...
CIMGUI_API ImGuiID            ImGuiGetKeyOwner(ImGuiKey key);
CIMGUI_API void               ImGuiSetKeyOwner(ImGuiKey key, ImGuiID owner_id, ImGuiInputFlags flags /* = 0 */);
CIMGUI_API void               ImGuiSetKeyOwnersForKeyChord(ImGuiKeyChord key, ImGuiID owner_id, ImGuiInputFlags flags /* = 0 */);
CIMGUI_API void               ImGuiSetItemKeyOwnerImGuiInputFlags(ImGuiKey key, ImGuiInputFlags flags);   // Set key owner to last item if it is hovered or active. Equivalent to 'if (IsItemHovered() || IsItemActive()) { SetKeyOwner(key, GetItemID());'.
CIMGUI_API bool               ImGuiTestKeyOwner(ImGuiKey key, ImGuiID owner_id);                          // Test that key is either not owned, either owned by 'owner_id'
CIMGUI_API ImGuiKeyOwnerData* ImGuiGetKeyOwnerData(ImGuiContext* ctx, ImGuiKey key);
...
CIMGUI_API bool ImGuiIsKeyDownID(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API bool ImGuiIsKeyPressedImGuiInputFlags(ImGuiKey key, ImGuiInputFlags flags);                                                 // Implied owner_id = 0
CIMGUI_API bool ImGuiIsKeyPressedImGuiInputFlagsEx(ImGuiKey key, ImGuiInputFlags flags, ImGuiID owner_id /* = 0 */);                   // Important: when transitioning from old to new IsKeyPressed(): old API has "bool repeat = true", so would default to repeat. New API requires explicit ImGuiInputFlags_Repeat.
CIMGUI_API bool ImGuiIsKeyReleasedID(ImGuiKey key, ImGuiID owner_id);
CIMGUI_API bool ImGuiIsKeyChordPressedImGuiInputFlags(ImGuiKeyChord key_chord, ImGuiInputFlags flags);                                 // Implied owner_id = 0
CIMGUI_API bool ImGuiIsKeyChordPressedImGuiInputFlagsEx(ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id /* = 0 */);
CIMGUI_API bool ImGuiIsMouseDownID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool ImGuiIsMouseClickedImGuiInputFlags(ImGuiMouseButton button, ImGuiInputFlags flags);                                    // Implied owner_id = 0
CIMGUI_API bool ImGuiIsMouseClickedImGuiInputFlagsEx(ImGuiMouseButton button, ImGuiInputFlags flags, ImGuiID owner_id /* = 0 */);
CIMGUI_API bool ImGuiIsMouseReleasedID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool ImGuiIsMouseDoubleClickedID(ImGuiMouseButton button, ImGuiID owner_id);
...
CIMGUI_API bool                 ImGuiShortcutID(ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);
CIMGUI_API bool                 ImGuiSetShortcutRouting(ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);   // owner_id needs to be explicit and cannot be 0
CIMGUI_API bool                 ImGuiTestShortcutRouting(ImGuiKeyChord key_chord, ImGuiID owner_id);
CIMGUI_API ImGuiKeyRoutingData* ImGuiGetShortcutRoutingData(ImGuiKeyChord key_chord);
...
CIMGUI_API void    ImGuiPushFocusScope(ImGuiID id);
CIMGUI_API void    ImGuiPopFocusScope(void);
CIMGUI_API ImGuiID ImGuiGetCurrentFocusScope(void);   // Focus scope we are outputting into, set by PushFocusScope()

// Drag and Drop
CIMGUI_API bool ImGuiIsDragDropActive(void);
CIMGUI_API bool ImGuiBeginDragDropTargetCustom(ImRect bb, ImGuiID id);
CIMGUI_API bool ImGuiBeginDragDropTargetViewport(ImGuiViewport* viewport);                                      // Implied p_bb = NULL
CIMGUI_API bool ImGuiBeginDragDropTargetViewportEx(ImGuiViewport* viewport, const ImRect* p_bb /* = NULL */);
CIMGUI_API void ImGuiClearDragDrop(void);
CIMGUI_API bool ImGuiIsDragDropPayloadBeingAccepted(void);
CIMGUI_API void ImGuiRenderDragDropTargetRectForItem(ImRect bb);
CIMGUI_API void ImGuiRenderDragDropTargetRectEx(ImDrawList* draw_list, ImRect bb);
...
CIMGUI_API ImGuiTypingSelectRequest* ImGuiGetTypingSelectRequest(void);                                                                                                                              // Implied flags = ImGuiTypingSelectFlags_None
CIMGUI_API ImGuiTypingSelectRequest* ImGuiGetTypingSelectRequestEx(ImGuiTypingSelectFlags flags /* = ImGuiTypingSelectFlags_None */);
CIMGUI_API int                       ImGuiTypingSelectFindMatch(ImGuiTypingSelectRequest* req, int items_count, const char* (*get_item_name_func)(void*, int), void* user_data, int nav_item_idx);
CIMGUI_API int                       ImGuiTypingSelectFindNextSingleCharMatch(ImGuiTypingSelectRequest* req, int items_count, const char* (*get_item_name_func)(void*, int), void* user_data, int nav_item_idx);
CIMGUI_API int                       ImGuiTypingSelectFindBestLeadingMatch(ImGuiTypingSelectRequest* req, int items_count, const char* (*get_item_name_func)(void*, int), void* user_data);

// Box-Select API
CIMGUI_API bool ImGuiBeginBoxSelect(ImRect scope_rect, ImGuiWindow* window, ImGuiID box_select_id, ImGuiMultiSelectFlags ms_flags);
CIMGUI_API void ImGuiEndBoxSelect(ImRect scope_rect, ImGuiMultiSelectFlags ms_flags);

// Multi-Select API
CIMGUI_API void                   ImGuiMultiSelectItemHeader(ImGuiID id, bool* p_selected, ImGuiButtonFlags* p_button_flags);
CIMGUI_API void                   ImGuiMultiSelectItemFooter(ImGuiID id, bool* p_selected, bool* p_pressed);
CIMGUI_API void                   ImGuiMultiSelectAddSetAll(ImGuiMultiSelectTempData* ms, bool selected);
CIMGUI_API void                   ImGuiMultiSelectAddSetRange(ImGuiMultiSelectTempData* ms, bool selected, int range_dir, ImGuiSelectionUserData first_item, ImGuiSelectionUserData last_item);
CIMGUI_API ImGuiBoxSelectState*   ImGuiGetBoxSelectState(ImGuiID id);
CIMGUI_API ImGuiMultiSelectState* ImGuiGetMultiSelectState(ImGuiID id);

// Internal Columns API (this is not exposed because we will encourage transitioning to the Tables API)
CIMGUI_API void             ImGuiSetWindowClipRectBeforeSetChannel(ImGuiWindow* window, ImRect clip_rect);
CIMGUI_API void             ImGuiBeginColumns(const char* str_id, int count, ImGuiOldColumnFlags flags /* = 0 */);   // setup number of columns. use an identifier to distinguish multiple column sets. close with EndColumns().
CIMGUI_API void             ImGuiEndColumns(void);                                                                   // close columns
CIMGUI_API void             ImGuiPushColumnClipRect(int column_index);
CIMGUI_API void             ImGuiPushColumnsBackground(void);
CIMGUI_API void             ImGuiPopColumnsBackground(void);
CIMGUI_API ImGuiID          ImGuiGetColumnsID(const char* str_id, int count);
CIMGUI_API ImGuiOldColumns* ImGuiFindOrCreateColumns(ImGuiWindow* window, ImGuiID id);
CIMGUI_API float            ImGuiGetColumnOffsetFromNorm(const ImGuiOldColumns* columns, float offset_norm);
CIMGUI_API float            ImGuiGetColumnNormFromOffset(const ImGuiOldColumns* columns, float offset);

// Tables: Candidates for public API
CIMGUI_API void  ImGuiTableOpenContextMenu(void);                        // Implied column_n = -1
CIMGUI_API void  ImGuiTableOpenContextMenuEx(int column_n /* = -1 */);
CIMGUI_API void  ImGuiTableSetColumnWidth(int column_n, float width);
CIMGUI_API void  ImGuiTableSetColumnSortDirection(int column_n, ImGuiSortDirection sort_direction, bool append_to_sort_specs);
CIMGUI_API int   ImGuiTableGetHoveredRow(void);                          // Retrieve *PREVIOUS FRAME* hovered row. This difference with TableGetHoveredColumn() is the reason why this is not public yet.
CIMGUI_API float ImGuiTableGetHeaderRowHeight(void);
CIMGUI_API float ImGuiTableGetHeaderAngledMaxLabelWidth(void);
CIMGUI_API void  ImGuiTablePushBackgroundChannel(void);
CIMGUI_API void  ImGuiTablePopBackgroundChannel(void);
CIMGUI_API void  ImGuiTablePushColumnChannel(int column_n);
CIMGUI_API void  ImGuiTablePopColumnChannel(void);
CIMGUI_API void  ImGuiTableAngledHeadersRowEx(ImGuiID row_id, float angle, float max_label_width, const ImGuiTableHeaderData* data, int data_count);

// Tables: Internals
CIMGUI_API ImGuiTable*             ImGuiGetCurrentTable(void);
CIMGUI_API ImGuiTable*             ImGuiTableFindByID(ImGuiID id);
CIMGUI_API bool                    ImGuiBeginTableWithID(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags /* = 0 */); // Implied outer_size = ImVec2(0, 0), inner_width = 0.0f
CIMGUI_API bool                    ImGuiBeginTableWithIDEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags /* = 0 */, ImVec2 outer_size /* = ImVec2(0, 0) */, float inner_width /* = 0.0f */);
CIMGUI_API void                    ImGuiTableBeginInitMemory(ImGuiTable* table, int columns_count);
CIMGUI_API void                    ImGuiTableBeginApplyRequests(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableSetupDrawChannels(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableUpdateLayout(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableUpdateBorders(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableUpdateColumnsWeightFromWidth(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableDrawBorders(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableDrawDefaultContextMenu(ImGuiTable* table, ImGuiTableFlags flags_for_section_to_display);
CIMGUI_API bool                    ImGuiTableBeginContextMenuPopup(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableMergeDrawChannels(ImGuiTable* table);
CIMGUI_API ImGuiTableInstanceData* ImGuiTableGetInstanceData(ImGuiTable* table, int instance_no);
CIMGUI_API ImGuiID                 ImGuiTableGetInstanceID(ImGuiTable* table, int instance_no);
CIMGUI_API void                    ImGuiTableSortSpecsSanitize(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableSortSpecsBuild(ImGuiTable* table);
CIMGUI_API ImGuiSortDirection      ImGuiTableGetColumnNextSortDirection(ImGuiTableColumn* column);
CIMGUI_API void                    ImGuiTableFixColumnSortDirection(ImGuiTable* table, ImGuiTableColumn* column);
CIMGUI_API float                   ImGuiTableGetColumnWidthAuto(ImGuiTable* table, ImGuiTableColumn* column);
CIMGUI_API void                    ImGuiTableBeginRow(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableEndRow(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableBeginCell(ImGuiTable* table, int column_n);
CIMGUI_API void                    ImGuiTableEndCell(ImGuiTable* table);
CIMGUI_API ImRect                  ImGuiTableGetCellBgRect(const ImGuiTable* table, int column_n);
CIMGUI_API const char*             ImGuiTableGetColumnNameImGuiTablePtr(const ImGuiTable* table, int column_n);
CIMGUI_API ImGuiID                 ImGuiTableGetColumnResizeID(ImGuiTable* table, int column_n);                                        // Implied instance_no = 0
CIMGUI_API ImGuiID                 ImGuiTableGetColumnResizeIDEx(ImGuiTable* table, int column_n, int instance_no /* = 0 */);
CIMGUI_API float                   ImGuiTableCalcMaxColumnWidth(const ImGuiTable* table, int column_n);
CIMGUI_API void                    ImGuiTableSetColumnWidthAutoSingle(ImGuiTable* table, int column_n);
CIMGUI_API void                    ImGuiTableSetColumnWidthAutoAll(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableRemove(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableGcCompactTransientBuffers(ImGuiTable* table);
CIMGUI_API void                    ImGuiTableGcCompactTransientBuffersImGuiTableTempDataPtr(ImGuiTableTempData* table);
CIMGUI_API void                    ImGuiTableGcCompactSettings(void);

// Tables: Settings
CIMGUI_API void                ImGuiTableLoadSettings(ImGuiTable* table);
CIMGUI_API void                ImGuiTableSaveSettings(ImGuiTable* table);
CIMGUI_API void                ImGuiTableResetSettings(ImGuiTable* table);
CIMGUI_API ImGuiTableSettings* ImGuiTableGetBoundSettings(ImGuiTable* table);
CIMGUI_API void                ImGuiTableSettingsAddSettingsHandler(void);
CIMGUI_API ImGuiTableSettings* ImGuiTableSettingsCreate(ImGuiID id, int columns_count);
CIMGUI_API ImGuiTableSettings* ImGuiTableSettingsFindByID(ImGuiID id);

// Tab Bars
CIMGUI_API ImGuiTabBar*  ImGuiGetCurrentTabBar(void);
CIMGUI_API ImGuiTabBar*  ImGuiTabBarFindByID(ImGuiID id);
CIMGUI_API void          ImGuiTabBarRemove(ImGuiTabBar* tab_bar);
CIMGUI_API bool          ImGuiBeginTabBarEx(ImGuiTabBar* tab_bar, ImRect bb, ImGuiTabBarFlags flags);
CIMGUI_API ImGuiTabItem* ImGuiTabBarFindTabByID(ImGuiTabBar* tab_bar, ImGuiID tab_id);
CIMGUI_API ImGuiTabItem* ImGuiTabBarFindTabByOrder(ImGuiTabBar* tab_bar, int order);
CIMGUI_API ImGuiTabItem* ImGuiTabBarGetCurrentTab(ImGuiTabBar* tab_bar);
CIMGUI_API int           ImGuiTabBarGetTabOrder(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API const char*   ImGuiTabBarGetTabName(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API void          ImGuiTabBarRemoveTab(ImGuiTabBar* tab_bar, ImGuiID tab_id);
CIMGUI_API void          ImGuiTabBarCloseTab(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API void          ImGuiTabBarQueueFocus(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);
CIMGUI_API void          ImGuiTabBarQueueFocusStr(ImGuiTabBar* tab_bar, const char* tab_name);
CIMGUI_API void          ImGuiTabBarQueueReorder(ImGuiTabBar* tab_bar, ImGuiTabItem* tab, int offset);
CIMGUI_API void          ImGuiTabBarQueueReorderFromMousePos(ImGuiTabBar* tab_bar, ImGuiTabItem* tab, ImVec2 mouse_pos);
CIMGUI_API bool          ImGuiTabBarProcessReorder(ImGuiTabBar* tab_bar);
CIMGUI_API bool          ImGuiTabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiWindow* docked_window);
CIMGUI_API void          ImGuiTabItemSpacing(const char* str_id, ImGuiTabItemFlags flags, float width);
CIMGUI_API ImVec2        ImGuiTabItemCalcSizeStr(const char* label, bool has_close_button_or_unsaved_marker);
CIMGUI_API ImVec2        ImGuiTabItemCalcSize(ImGuiWindow* window);
CIMGUI_API void          ImGuiTabItemBackground(ImDrawList* draw_list, ImRect bb, ImGuiTabItemFlags flags, ImU32 col);
CIMGUI_API void          ImGuiTabItemLabelAndCloseButton(ImDrawList* draw_list, ImRect bb, ImGuiTabItemFlags flags, ImVec2 frame_padding, const char* label, ImGuiID tab_id, ImGuiID close_button_id, bool is_contents_visible, bool* out_just_closed, bool* out_text_clipped);

// Render helpers
// AVOID USING OUTSIDE OF IMGUI.CPP! NOT FOR PUBLIC CONSUMPTION. THOSE FUNCTIONS ARE A MESS. THEIR SIGNATURE AND BEHAVIOR WILL CHANGE, THEY NEED TO BE REFACTORED INTO SOMETHING DECENT.
// NB: All position are in absolute pixels coordinates (we are never using window coordinates internally)
CIMGUI_API void        ImGuiRenderText(ImVec2 pos, const char* text);                                                                                                    // Implied text_end = NULL, hide_text_after_hash = true
CIMGUI_API void        ImGuiRenderTextEx(ImVec2 pos, const char* text, const char* text_end /* = NULL */, bool hide_text_after_hash /* = true */);
CIMGUI_API void        ImGuiRenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width);
CIMGUI_API void        ImGuiRenderTextClipped(ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known);                 // Implied align = ImVec2(0, 0), clip_rect = NULL
CIMGUI_API void        ImGuiRenderTextClippedEx(ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, ImVec2 align /* = ImVec2(0, 0) */, const ImRect* clip_rect /* = NULL */);
CIMGUI_API void        ImGuiRenderTextClippedWithDrawList(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known); // Implied align = ImVec2(0, 0), clip_rect = NULL
CIMGUI_API void        ImGuiRenderTextClippedWithDrawListEx(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, ImVec2 align /* = ImVec2(0, 0) */, const ImRect* clip_rect /* = NULL */);
CIMGUI_API void        ImGuiRenderTextEllipsis(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, float ellipsis_max_x, const char* text, const char* text_end, const ImVec2* text_size_if_known);
CIMGUI_API void        ImGuiRenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col);                                                                                     // Implied borders = true, rounding = 0.0f
CIMGUI_API void        ImGuiRenderFrameEx(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool borders /* = true */, float rounding /* = 0.0f */);
CIMGUI_API void        ImGuiRenderFrameBorder(ImVec2 p_min, ImVec2 p_max);                                                                                               // Implied rounding = 0.0f
CIMGUI_API void        ImGuiRenderFrameBorderEx(ImVec2 p_min, ImVec2 p_max, float rounding /* = 0.0f */);
CIMGUI_API void        ImGuiRenderColorRectWithAlphaCheckerboard(ImDrawList* draw_list, ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, float grid_step, ImVec2 grid_off);   // Implied rounding = 0.0f, flags = 0
CIMGUI_API void        ImGuiRenderColorRectWithAlphaCheckerboardEx(ImDrawList* draw_list, ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, float grid_step, ImVec2 grid_off, float rounding /* = 0.0f */, ImDrawFlags flags /* = 0 */);
CIMGUI_API void        ImGuiRenderNavCursor(ImRect bb, ImGuiID id);                                                                                                      // Implied flags = ImGuiNavRenderCursorFlags_None
CIMGUI_API void        ImGuiRenderNavCursorEx(ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags /* = ImGuiNavRenderCursorFlags_None */);                            // Navigation highlight
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API void ImGuiRenderNavHighlight(ImRect bb, ImGuiID id);                                                                             // Implied flags = ImGuiNavRenderCursorFlags_None
CIMGUI_API void ImGuiRenderNavHighlightEx(ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags /* = ImGuiNavRenderCursorFlags_None */);   // Renamed in 1.91.4
#endif // #ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API const char* ImGuiFindRenderedTextEnd(const char* text);                                                                                                       // Implied text_end = NULL
CIMGUI_API const char* ImGuiFindRenderedTextEndEx(const char* text, const char* text_end /* = NULL */);                                                                  // Find the optional ## from which we stop displaying text.
CIMGUI_API void        ImGuiRenderMouseCursor(ImVec2 pos, float scale, ImGuiMouseCursor mouse_cursor, ImU32 col_fill, ImU32 col_border, ImU32 col_shadow);

// Render helpers (those functions don't access any ImGui state!)
CIMGUI_API void ImGuiRenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir);                                                       // Implied scale = 1.0f
CIMGUI_API void ImGuiRenderArrowEx(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float scale /* = 1.0f */);
CIMGUI_API void ImGuiRenderBullet(ImDrawList* draw_list, ImVec2 pos, ImU32 col);
CIMGUI_API void ImGuiRenderCheckMark(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float sz);
CIMGUI_API void ImGuiRenderArrowPointingAt(ImDrawList* draw_list, ImVec2 pos, ImVec2 half_sz, ImGuiDir direction, ImU32 col);
CIMGUI_API void ImGuiRenderRectFilledRangeH(ImDrawList* draw_list, ImRect rect, ImU32 col, float x_start_norm, float x_end_norm, float rounding);
CIMGUI_API void ImGuiRenderRectFilledWithHole(ImDrawList* draw_list, ImRect outer, ImRect inner, ImU32 col, float rounding);

// Widgets: Text
CIMGUI_API void ImGuiTextEx(const char* text);                                                                        // Implied text_end = NULL, flags = 0
CIMGUI_API void ImGuiTextExEx(const char* text, const char* text_end /* = NULL */, ImGuiTextFlags flags /* = 0 */);
CIMGUI_API void ImGuiTextAligned(float align_x, float size_x, const char* fmt, ...);                                  // FIXME-WIP: Works but API is likely to be reworked. This is designed for 1 item on the line. (#7024)
CIMGUI_API void ImGuiTextAlignedV(float align_x, float size_x, const char* fmt, va_list args);

// Widgets
CIMGUI_API bool ImGuiButtonWithFlags(const char* label);                                                                             // Implied size_arg = ImVec2(0, 0), flags = 0
CIMGUI_API bool ImGuiButtonWithFlagsEx(const char* label, ImVec2 size_arg /* = ImVec2(0, 0) */, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API bool ImGuiArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API bool ImGuiImageButtonWithFlags(ImGuiID id, ImTextureRef tex_ref, ImVec2 image_size, ImVec2 uv0, ImVec2 uv1, ImVec4 bg_col, ImVec4 tint_col, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API void ImGuiSeparatorEx(ImGuiSeparatorFlags flags);                                                                         // Implied thickness = 1.0f
CIMGUI_API void ImGuiSeparatorExEx(ImGuiSeparatorFlags flags, float thickness /* = 1.0f */);
CIMGUI_API void ImGuiSeparatorTextEx(ImGuiID id, const char* label, const char* label_end, float extra_width);
CIMGUI_API bool ImGuiCheckboxFlagsImS64Ptr(const char* label, ImS64* flags, ImS64 flags_value);
CIMGUI_API bool ImGuiCheckboxFlagsImU64Ptr(const char* label, ImU64* flags, ImU64 flags_value);

// Widgets: Window Decorations
CIMGUI_API bool    ImGuiCloseButton(ImGuiID id, ImVec2 pos);
CIMGUI_API bool    ImGuiCollapseButton(ImGuiID id, ImVec2 pos);
CIMGUI_API void    ImGuiScrollbar(ImGuiAxis axis);
CIMGUI_API bool    ImGuiScrollbarEx(ImRect bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 avail_v, ImS64 contents_v);   // Implied draw_rounding_flags = 0
CIMGUI_API bool    ImGuiScrollbarExEx(ImRect bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 avail_v, ImS64 contents_v, ImDrawFlags draw_rounding_flags /* = 0 */);
CIMGUI_API ImRect  ImGuiGetWindowScrollbarRect(ImGuiWindow* window, ImGuiAxis axis);
CIMGUI_API ImGuiID ImGuiGetWindowScrollbarID(ImGuiWindow* window, ImGuiAxis axis);
CIMGUI_API ImGuiID ImGuiGetWindowResizeCornerID(ImGuiWindow* window, int n);                                                      // 0..3: corners
CIMGUI_API ImGuiID ImGuiGetWindowResizeBorderID(ImGuiWindow* window, ImGuiDir dir);

// Widgets low-level behaviors
CIMGUI_API bool ImGuiButtonBehavior(ImRect bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API bool ImGuiDragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags);
CIMGUI_API bool ImGuiSliderBehavior(ImRect bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb);
CIMGUI_API bool ImGuiSplitterBehavior(ImRect bb, ImGuiID id, ImGuiAxis axis, float* size1, float* size2, float min_size1, float min_size2);   // Implied hover_extend = 0.0f, hover_visibility_delay = 0.0f, bg_col = 0
CIMGUI_API bool ImGuiSplitterBehaviorEx(ImRect bb, ImGuiID id, ImGuiAxis axis, float* size1, float* size2, float min_size1, float min_size2, float hover_extend /* = 0.0f */, float hover_visibility_delay /* = 0.0f */, ImU32 bg_col /* = 0 */);

// Widgets: Tree Nodes
CIMGUI_API bool ImGuiTreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label);   // Implied label_end = NULL
CIMGUI_API bool ImGuiTreeNodeBehaviorEx(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end /* = NULL */);
CIMGUI_API void ImGuiTreeNodeDrawLineToChildNode(ImVec2 target_pos);
CIMGUI_API void ImGuiTreeNodeDrawLineToTreePop(const ImGuiTreeNodeStackData* data);
CIMGUI_API void ImGuiTreePushOverrideID(ImGuiID id);
CIMGUI_API bool ImGuiTreeNodeGetOpen(ImGuiID storage_id);
CIMGUI_API void ImGuiTreeNodeSetOpen(ImGuiID storage_id, bool open);
CIMGUI_API bool ImGuiTreeNodeUpdateNextOpen(ImGuiID storage_id, ImGuiTreeNodeFlags flags);        // Return open state. Consume previous SetNextItemOpen() data, if any. May return true when logging.

// Data type helpers
CIMGUI_API const ImGuiDataTypeInfo* ImGuiDataTypeGetInfo(ImGuiDataType data_type);
CIMGUI_API int                      ImGuiDataTypeFormatString(char* buf, int buf_size, ImGuiDataType data_type, const void* p_data, const char* format);
CIMGUI_API void                     ImGuiDataTypeApplyOp(ImGuiDataType data_type, int op, void* output, const void* arg_1, const void* arg_2);
CIMGUI_API bool                     ImGuiDataTypeApplyFromText(const char* buf, ImGuiDataType data_type, void* p_data, const char* format);   // Implied p_data_when_empty = NULL
CIMGUI_API bool                     ImGuiDataTypeApplyFromTextEx(const char* buf, ImGuiDataType data_type, void* p_data, const char* format, void* p_data_when_empty /* = NULL */);
CIMGUI_API int                      ImGuiDataTypeCompare(ImGuiDataType data_type, const void* arg_1, const void* arg_2);
CIMGUI_API bool                     ImGuiDataTypeClamp(ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max);
CIMGUI_API bool                     ImGuiDataTypeIsZero(ImGuiDataType data_type, const void* p_data);

// InputText
CIMGUI_API bool ImGuiInputTextWithHintAndSize(const char* label, const char* hint, char* buf, int buf_size, ImVec2 size_arg, ImGuiInputTextFlags flags);   // Implied callback = NULL, user_data = NULL
CIMGUI_API bool ImGuiInputTextWithHintAndSizeEx(const char* label, const char* hint, char* buf, int buf_size, ImVec2 size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback /* = NULL */, void* user_data /* = NULL */);
CIMGUI_API void ImGuiInputTextDeactivateHook(ImGuiID id);
CIMGUI_API bool ImGuiTempInputText(ImRect bb, ImGuiID id, const char* label, char* buf, int buf_size, ImGuiInputTextFlags flags);
CIMGUI_API bool ImGuiTempInputScalar(ImRect bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format);                 // Implied p_clamp_min = NULL, p_clamp_max = NULL
CIMGUI_API bool ImGuiTempInputScalarEx(ImRect bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min /* = NULL */, const void* p_clamp_max /* = NULL */);
CIMGUI_API bool ImGuiTempInputIsActive(ImGuiID id);
CIMGUI_API void ImGuiSetNextItemRefVal(ImGuiDataType data_type, void* p_data);
CIMGUI_API bool ImGuiIsItemActiveAsInputText(void);                                                                                                        // This may be useful to apply workaround that a based on distinguish whenever an item is active as a text input field.

// Color
CIMGUI_API void ImGuiColorTooltip(const char* text, const float* col, ImGuiColorEditFlags flags);
CIMGUI_API void ImGuiColorEditOptionsPopup(const float* col, ImGuiColorEditFlags flags);
CIMGUI_API void ImGuiColorPickerOptionsPopup(const float* ref_col, ImGuiColorEditFlags flags);

// Plot
CIMGUI_API int ImGuiPlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 size_arg);

// Shade functions (write over already created vertices)
CIMGUI_API void ImGuiShadeVertsLinearColorGradientKeepAlpha(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, ImVec2 gradient_p0, ImVec2 gradient_p1, ImU32 col0, ImU32 col1);
CIMGUI_API void ImGuiShadeVertsLinearUV(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, ImVec2 a, ImVec2 b, ImVec2 uv_a, ImVec2 uv_b, bool clamp);
CIMGUI_API void ImGuiShadeVertsTransformPos(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, ImVec2 pivot_in, float cos_a, float sin_a, ImVec2 pivot_out);

// Garbage collection
CIMGUI_API void ImGuiGcCompactTransientMiscBuffers(void);
CIMGUI_API void ImGuiGcCompactTransientWindowBuffers(ImGuiWindow* window);
CIMGUI_API void ImGuiGcAwakeTransientWindowBuffers(ImGuiWindow* window);

// Error handling, State Recovery
CIMGUI_API bool ImGuiErrorLog(const char* msg);
CIMGUI_API void ImGuiErrorRecoveryStoreState(ImGuiErrorRecoveryState* state_out);
CIMGUI_API void ImGuiErrorRecoveryTryToRecoverState(const ImGuiErrorRecoveryState* state_in);
CIMGUI_API void ImGuiErrorRecoveryTryToRecoverWindowState(const ImGuiErrorRecoveryState* state_in);
CIMGUI_API void ImGuiErrorCheckUsingSetCursorPosToExtendParentBoundaries(void);
CIMGUI_API void ImGuiErrorCheckEndFrameFinalizeErrorTooltip(void);
CIMGUI_API bool ImGuiBeginErrorTooltip(void);
CIMGUI_API void ImGuiEndErrorTooltip(void);

// Debug Tools
CIMGUI_API void ImGuiDebugAllocHook(ImGuiDebugAllocInfo* info, int frame_count, void* ptr, size_t size);                   // size >= 0 : alloc, size = -1 : free
CIMGUI_API void ImGuiDebugDrawCursorPos(void);                                                                             // Implied col = IM_COL32(255, 0, 0, 255)
CIMGUI_API void ImGuiDebugDrawCursorPosEx(ImU32 col /* = IM_COL32(255, 0, 0, 255) */);
CIMGUI_API void ImGuiDebugDrawLineExtents(void);                                                                           // Implied col = IM_COL32(255, 0, 0, 255)
CIMGUI_API void ImGuiDebugDrawLineExtentsEx(ImU32 col /* = IM_COL32(255, 0, 0, 255) */);
CIMGUI_API void ImGuiDebugDrawItemRect(void);                                                                              // Implied col = IM_COL32(255, 0, 0, 255)
CIMGUI_API void ImGuiDebugDrawItemRectEx(ImU32 col /* = IM_COL32(255, 0, 0, 255) */);
CIMGUI_API void ImGuiDebugTextUnformattedWithLocateItem(const char* line_begin, const char* line_end);
CIMGUI_API void ImGuiDebugLocateItem(ImGuiID target_id);                                                                   // Call sparingly: only 1 at the same time!
CIMGUI_API void ImGuiDebugLocateItemOnHover(ImGuiID target_id);                                                            // Only call on reaction to a mouse Hover: because only 1 at the same time!
CIMGUI_API void ImGuiDebugLocateItemResolveWithLastItem(void);
CIMGUI_API void ImGuiDebugBreakClearData(void);
CIMGUI_API bool ImGuiDebugBreakButton(const char* label, const char* description_of_location);
CIMGUI_API void ImGuiDebugBreakButtonTooltip(bool keyboard_only, const char* description_of_location);
CIMGUI_API void ImGuiShowFontAtlas(ImFontAtlas* atlas);
CIMGUI_API void ImGuiDebugHookIdInfo(ImGuiID id, ImGuiDataType data_type, const void* data_id, const void* data_id_end);
CIMGUI_API void ImGuiDebugNodeColumns(ImGuiOldColumns* columns);
CIMGUI_API void ImGuiDebugNodeDrawList(ImGuiWindow* window, ImGuiViewportP* viewport, const ImDrawList* draw_list, const char* label);
CIMGUI_API void ImGuiDebugNodeDrawCmdShowMeshAndBoundingBox(ImDrawList* out_draw_list, const ImDrawList* draw_list, const ImDrawCmd* draw_cmd, bool show_mesh, bool show_aabb);
CIMGUI_API void ImGuiDebugNodeFont(ImFont* font);
CIMGUI_API void ImGuiDebugNodeFontGlyphesForSrcMask(ImFont* font, ImFontBaked* baked, int src_mask);
CIMGUI_API void ImGuiDebugNodeFontGlyph(ImFont* font, const ImFontGlyph* glyph);
CIMGUI_API void ImGuiDebugNodeTexture(ImTextureData* tex, int int_id);                                                     // Implied highlight_rect = NULL
CIMGUI_API void ImGuiDebugNodeTextureEx(ImTextureData* tex, int int_id, const ImFontAtlasRect* highlight_rect /* = NULL */); // ID used to facilitate persisting the "current" texture.
CIMGUI_API void ImGuiDebugNodeStorage(ImGuiStorage* storage, const char* label);
CIMGUI_API void ImGuiDebugNodeTabBar(ImGuiTabBar* tab_bar, const char* label);
CIMGUI_API void ImGuiDebugNodeTable(ImGuiTable* table);
CIMGUI_API void ImGuiDebugNodeTableSettings(ImGuiTableSettings* settings);
CIMGUI_API void ImGuiDebugNodeTypingSelectState(ImGuiTypingSelectState* state);
CIMGUI_API void ImGuiDebugNodeMultiSelectState(ImGuiMultiSelectState* state);
CIMGUI_API void ImGuiDebugNodeWindow(ImGuiWindow* window, const char* label);
CIMGUI_API void ImGuiDebugNodeWindowSettings(ImGuiWindowSettings* settings);
CIMGUI_API void ImGuiDebugNodeWindowsList(ImVector_ImGuiWindowPtr* windows, const char* label);
CIMGUI_API void ImGuiDebugNodeWindowsListByBeginStackParent(ImGuiWindow** windows, int windows_size, ImGuiWindow* parent_in_begin_stack);
CIMGUI_API void ImGuiDebugNodeViewport(ImGuiViewportP* viewport);
CIMGUI_API void ImGuiDebugRenderKeyboardPreview(ImDrawList* draw_list);
CIMGUI_API void ImGuiDebugRenderViewportThumbnail(ImDrawList* draw_list, ImGuiViewportP* viewport, ImRect bb);
